        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('leaves.edit', $data->id) }}
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('leaves.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <textarea class="form-control" id="response" name="response" rows="3"
                                            placeholder="Masukan Balasan">{{ old('response', $data->response) }}</textarea>
                                        @error('response')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
