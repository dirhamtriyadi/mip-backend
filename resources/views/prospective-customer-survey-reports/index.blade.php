        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('prospective-customer-survey-reports') }}
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Laporan Survei</h3>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <form action="{{ route('prospective-customer-survey-reports.index') }}"
                                            method="get">
                                            <div class="d-flex">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <div class="d-flex flex-column justify-content-center">
                                            ...
                                            <form action="{{ route('prospective-customer-survey-reports.export') }}"
                                                method="get">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            {{-- Create to import data from excel --}}
                                            <form action="{{ route('prospective-customer-survey-reports.exportPdf') }}"
                                                method="get">
                                                <input type="hidden" class="form-control" name="start_date"
                                                    placeholder="Masukan Tanggal" value="{{ $start_date }}">
                                                <input type="hidden" class="form-control" name="end_date"
    ...
    <script>
        $(function() {
            ...
            $("#table").DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ route('prospective-customer-survey-reports.index') }}/fetch-data-table",
                    "type": "post",
                    "data": {
                        "_token": "{{ csrf_token() }}",
