        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('customer-billings.edit', $data->id) }}
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form id="billing-form" action="{{ route('customer-billings.update', $data->id) }}"
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control" id="bill_number" name="bill_number"
                                            ...
                                            value="{{ old('bill_number', $data->bill_number) }}">
                                        @error('bill_number')
                                        ...
                                        <select class="form-control select2" style="width: 100%;" id="customer_id"
                                            ...
                                            @foreach ($customers as $customer)
                                                <option value="{{ $customer->id }}"
                                                    {{ old('customer_id', $data->customer_id) == $customer->id ? 'selected' : '' }}>
                                    ...
                                    {{-- <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <select class="form-control select2" style="width: 100%;" id="status"
                                            ...
                                            <option value="pending"
                                                {{ old('status', $data->status->value) == 'pending' ? 'selected' : '' }}>
                                                Menunggu</option>
                                            <option value="process"
                                                {{ old('status', $data->status->value) == 'process' ? 'selected' : '' }}>
                                                Proses</option>
                                            <option value="success"
                                                {{ old('status', $data->status->value) == 'success' ? 'selected' : '' }}>
                                                Berhasil</option>
                                            <option value="cancel"
                                                {{ old('status', $data->status->value) == 'cancel' ? 'selected' : '' }}>
                                                Gagal</option>
                                        </select>
                                        @error('status')
                                            <div class="alert alert-danger">{{ $message }}</div>
