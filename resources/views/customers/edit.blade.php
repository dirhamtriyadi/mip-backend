                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form id="bank-account-form" action="{{ route('customers.update', $customer->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="number" class="form-control" id="no_contract" name="no_contract"
                                            placeholder="Masukkan Nama" value="{{ old('no_contract', $customer->no_contract) }}" required>
                                        @error('no_contract')
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control" id="name_customer" name="name_customer"
                                            placeholder="Masukkan Nama Nasabah" value="{{ old('name_customer', $customer->name_customer) }}" required>
                                        @error('name_customer')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control" id="name_mother" name="name_mother"
                                            placeholder="Masukkan Nama Ibu" value="{{ old('name_mother', $customer->name_mother) }}">
                                        @error('name_mother')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control" id="phone_number" name="phone_number"
                                            placeholder="Masukkan Nomor HP" value="{{ old('phone_number', $customer->phone_number) }}"
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <textarea class="form-control" id="address" name="address" placeholder="Masukkan Nama">{{ old('address', $customer->address) }}</textarea>
                                        @error('address')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control" id="village" name="village"
                                            placeholder="Masukkan Desa" value="{{ old('village', $customer->village) }}">
                                        @error('village')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control" id="subdistrict" name="subdistrict"
                                            placeholder="Masukkan Kecamatan" value="{{ old('subdistrict', $customer->subdistrict) }}">
                                        @error('subdistrict')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control text-left" id="margin_start"
                                            ...
                                            value="{{ old('margin_start', $customer->margin_start) }}" data-mask>
                                        @error('margin_start')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control text-left" id="margin_remaining"
                                            ...
                                            value="{{ old('margin_remaining', $customer->margin_remaining) }}" data-mask>
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control text-left" id="installments"
                                            ...
                                            value="{{ old('installments', $customer->installments) }}" data-mask>
                                        @error('installments')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="number" class="form-control" id="month_arrears" name="month_arrears"
                                            placeholder="Masukkan Tunggak Bulan" value="{{ old('month_arrears', $customer->month_arrears) }}">
                                        @error('month_arrears')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control text-left" id="arrears"
                                            ...
                                            value="{{ old('arrears', $customer->arrears) }}" data-mask>
                                        @error('arrears')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input"
                                                data-target="#reservationdate" name="due_date" placeholder="Masukan Tanggal" value="{{ old('due_date', $customer->due_date) }}">
