        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('prospective-customer-surveys.create') }}
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <form id="survey-form" action="{{ route('prospective-customer-surveys.store') }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <select class="form-control select2" style="width: 100%;" id="status"
                                            ...
                                            <option value="ongoing" {{ old('status') == 'ongoing' ? 'selected' : '' }}>
                                                Proses</option>
                                            <option value="done" {{ old('status') == 'done' ? 'selected' : '' }}>Berhasil
                                            </option>
                                        </select>
                                        @error('status')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control" id="address" name="address"
                                            placeholder="Masukkan alamat calon nasabah" value="{{ old('address') }}">
                                        @error('address')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control" id="number_ktp" name="number_ktp"
                                            placeholder="Masukkan nomor KTP calon nasabah" value="{{ old('number_ktp') }}">
                                        @error('number_ktp')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control" id="job_type" name="job_type"
                                            placeholder="Masukkan jenis pekerjaan" value="{{ old('job_type') }}">
                                        @error('job_type')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control" id="company_name" name="company_name"
                                            placeholder="Masukkan nama perusahaan" value="{{ old('company_name') }}">
                                        @error('company_name')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control" id="job_level" name="job_level"
                                            placeholder="Masukkan jabatan" value="{{ old('job_level') }}">
                                        @error('job_level')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control" id="children" name="children"
                                            placeholder="Masukkan tanggungan" value="{{ old('children') }}">
                                        @error('children')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control" id="wife" name="wife"
                                            placeholder="Masukkan tanggungan istri" value="{{ old('wife') }}">
                                        @error('wife')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group" style="margin-top: 10px;">
                                        ...
                                        <input type="text" class="form-control" id="couple_jobs" name="couple_jobs"
                                            placeholder="Masukkan pekerjaan pasangan" value="{{ old('couple_jobs') }}">
                                        @error('couple_jobs')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
