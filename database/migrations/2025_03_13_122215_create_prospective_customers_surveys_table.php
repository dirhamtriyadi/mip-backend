...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('prospective-customer-surveys', function (Blueprint $table) {
            ...
            $table->string('salary')->nullable()->comment('Gaji');
            $table->string('other_business')->nullable()->comment('Pendapatan usaha tambahan');
            $table->string('monthly_living_expenses')->nullable()->comment('Biaya hidup per bulan');
            ...
            $table->string('couple_income')->nullable()->comment('Pendapatan pasangan');
            $table->string('bank_debt')->nullable()->comment('Hutang bank');
            $table->string('cooperative_debt')->nullable()->comment('Hutang koperasi');
            $table->string('personal_debt')->nullable()->comment('Hutang perorangan');
            $table->string('online_debt')->nullable()->comment('Hutang online');
            ...
            $table->string('loan_application')->nullable()->comment('Pengajuan pinjaman');
