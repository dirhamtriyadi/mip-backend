...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('prospective-customer-surveys', function (Blueprint $table) {
            ...
            $table->bigInteger('salary')->default(0)->comment('Gaji');
            $table->bigInteger('other_business')->default(0)->comment('Pendapatan usaha tambahan');
            $table->bigInteger('monthly_living_expenses')->default(0)->comment('Biaya hidup per bulan');
            ...
            $table->bigInteger('couple_income')->default(0)->comment('Pendapatan pasangan');
            $table->bigInteger('bank_debt')->default(0)->comment('Hutang bank');
            $table->bigInteger('cooperative_debt')->default(0)->comment('Hutang koperasi');
            $table->bigInteger('personal_debt')->default(0)->comment('Hutang perorangan');
            $table->bigInteger('online_debt')->default(0)->comment('Hutang online');
            ...
            $table->bigInteger('loan_application')->default(0)->comment('Pengajuan pinjaman');
